...
Outro aspecto importante para quem trabalha com programação é o uso de loopings (iterações). Para isso, utilizaremos a ferramenta `for`.
...
### Mesclando funções, iterações e expressões lógicas
